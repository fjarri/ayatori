...
pub use crate::{
    ...
    graph_representation::{
        ...
        PublicInputs, Receive, ScalarArgument, SendAll, SendBC, SendDM, SerializeAndSignBC, SerializeAndSignDM,
        ...
        merge_scalars, receive, receive_split, scalar_alias, send_all,
    },
